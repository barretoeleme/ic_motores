...
print("Results in Randomized Search for XGBoost in hysteresis loss prediction in motor V")
...
results.to_csv("~/ic_motores/IniciacaoCientifica/results/V/hysteresis/results_xgb_rand.csv")
...
data.to_csv("~/ic_motores/IniciacaoCientifica/pred/V/hysteresis/pred_xgb_rand.csv")
