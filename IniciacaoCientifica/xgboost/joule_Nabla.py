...
print("Results in Randomized Search for XGBoost in joule loss prediction in motor Nabla")
...
results.to_csv("~/ic_motores/IniciacaoCientifica/results/Nabla/joule/results_xgb_rand.csv")
...
data.to_csv("~/ic_motores/IniciacaoCientifica/pred/Nabla/joule/pred_xgb_rand.csv")
