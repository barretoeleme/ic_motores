...
print("Random forest model results in joule loss for motor V")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/V/joule/results_rand_for.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/V/joule/pred_rand_for.csv")
