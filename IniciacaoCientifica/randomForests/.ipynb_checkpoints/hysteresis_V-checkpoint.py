...
print("Random forest model results in hysteresis loss for motor V")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/V/hysteresis/results_rand_for.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/V/hysteresis/pred_rand_for.csv")
