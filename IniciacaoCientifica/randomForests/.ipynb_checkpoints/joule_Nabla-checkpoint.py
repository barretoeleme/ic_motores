...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/Nabla/joule/results_rand_for.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/Nabla/joule/pred_rand_for.csv")
