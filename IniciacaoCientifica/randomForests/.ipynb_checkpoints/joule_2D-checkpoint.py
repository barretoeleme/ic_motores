...
print("Random forest model results in joule loss for motor 2D")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/2D/joule/results_rand_for.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/2D/joule/pred_rand_for.csv")
