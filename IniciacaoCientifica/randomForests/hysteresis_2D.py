...
print("Random forest model results in hysteresis loss for motor 2D")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/2D/hysteresis/results_rand_for.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/2D/hysteresis/pred_rand_for.csv")
