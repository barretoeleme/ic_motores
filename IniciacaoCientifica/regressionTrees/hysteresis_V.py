...
print("Regression tree model results in hysteresis loss for motor V")
...
results.to_csv("/mnt/c/prog/ic_motores/IniciacaoCientifica/results/V/hysteresis/results_reg_tree.csv")
...
data.to_csv("/mnt/c/prog/ic_motores/IniciacaoCientifica/pred/V/hysteresis/pred_reg_tree.csv")
