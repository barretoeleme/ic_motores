...
results.to_csv("~/ic_motores/IniciacaoCientifica/results/2D/joule/results_xgb_rand.csv")
...
data.to_csv("~/ic_motores/IniciacaoCientifica/pred/2D/joule/pred_xgb_rand.csv")
