...
print("Results in Randomized Search for XGBoost in hysteresis loss prediction in motor Nabla")
...
results.to_csv("~/ic_motores/IniciacaoCientifica/results/Nabla/hysteresis/results_xgb_rand.csv")
...
data.to_csv("~/ic_motores/IniciacaoCientifica/pred/Nabla/hysteresis/pred_xgb_rand.csv")
