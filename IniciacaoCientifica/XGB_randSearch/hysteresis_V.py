...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/V/hysteresis/results_xgb_rand.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/V/hysteresis/pred_xgb_rand.csv")
