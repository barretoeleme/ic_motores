...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/Nabla/joule/results_xgb_rand.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/Nabla/joule/pred_xgb_rand.csv")
