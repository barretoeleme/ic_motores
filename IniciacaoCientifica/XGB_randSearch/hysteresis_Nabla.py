...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/Nabla/hysteresis/results_xgb_rand.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/Nabla/hysteresis/pred_xgb_rand.csv")
