...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/V/joule/results_xgb_rand.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/V/joule/pred_xgb_rand.csv")
