...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/2D/joule/results_lin_reg.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/2D/joule/pred_lin_reg.csv")
