...
model_Nabla = LinearRegression()
model_Nabla.fit(X_train, y_train)

predictions = model_Nabla.predict(X_test)
print("Linear regression model results in joule loss for motor Nabla")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/Nabla/joule/results_lin_reg.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/Nabla/joule/pred_lin_reg.csv")
