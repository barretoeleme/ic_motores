...
print("Results in Randomized Search for CatBoost in joule loss prediction in motor 2D")
...
results.to_csv("~/ic_motores/IniciacaoCientifica/results/2D/joule/results_cat_rand.csv")
...
data.to_csv("~/ic_motores/IniciacaoCientifica/pred/2D/joule/pred_cat_rand.csv")
