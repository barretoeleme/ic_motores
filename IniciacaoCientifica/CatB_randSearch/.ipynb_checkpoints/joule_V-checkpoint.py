...
print("Results in Randomized Search for CatBoost in joule loss prediction in motor V")
...
results.to_csv("~/ic_motores/IniciacaoCientifica/results/V/joule/results_cat_rand.csv")
...
data.to_csv("~/ic_motores/IniciacaoCientifica/pred/V/joule/pred_cat_rand.csv")
