...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/2D/hysteresis/results_catboost.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/2D/hysteresis/pred_catboost.csv")
