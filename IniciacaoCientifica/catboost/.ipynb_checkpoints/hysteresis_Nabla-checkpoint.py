...
print("CatBoost model results in hysteresis loss for motor Nabla")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/Nabla/hysteresis/results_catboost.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/Nabla/hysteresis/pred_catboost.csv")
