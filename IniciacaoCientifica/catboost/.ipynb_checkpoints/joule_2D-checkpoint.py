...
print("CatBoost model results in joule loss for motor 2D")
...
results.to_csv("/mnt/c/prog/IniciacaoCientifica/results/2D/joule/results_catboost.csv")
...
data.to_csv("/mnt/c/prog/IniciacaoCientifica/pred/2D/joule/pred_catboost.csv")
